...
const schema = new mongoose.Schema({
  ...
  purpose:{type:String,enum:['wallet_deposit','system_wallet_deposit','order','fintech_service','reseller_api_payment'],required:true,index:true},
  user:{type:mongoose.Schema.Types.ObjectId,ref:'User',default:null,index:true},
  order:{type:mongoose.Schema.Types.ObjectId,ref:'Order',default:null,index:true},
  fintechServiceOrder:{type:mongoose.Schema.Types.ObjectId,ref:'FintechServiceOrder',default:null,index:true},

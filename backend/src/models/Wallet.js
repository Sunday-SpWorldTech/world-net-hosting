...
const walletSchema = new mongoose.Schema({
  ...
  legacyPaymentCustomerCode: { type: String, default: '', index: true },
  dedicatedAccount: {
    ...
    currency: { type: String, default: 'NGN' },
    assignmentStatus: { type: String, enum: ['not_requested','pending','active','rejected','suspended','failed'], default: 'not_requested' },
